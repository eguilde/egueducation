...
if ($actualCount -ne 469) { throw "Router extraction drift: expected 469 concrete operations, found $actualCount. Update this guard intentionally after auditing the router." }
