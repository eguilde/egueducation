...
if ($actualCount -ne 465) { throw "Router extraction drift: expected 465 concrete operations, found $actualCount. Update this guard intentionally after auditing the router." }
