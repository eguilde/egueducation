...
-- Missing tables required by schema contract
...
-- Populate existing search_tsv values
...
create or replace function setup_archive_rls() returns void as $$
declare
    tbl text;
begin
...
select setup_archive_rls();
drop function setup_archive_rls();
