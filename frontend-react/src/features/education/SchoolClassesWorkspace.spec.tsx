...
describe("SchoolClassesWorkspace", () => {
  afterEach(cleanup);
  it("exposes its page title as a semantic heading", async () => { const client=api();view(client);expect(await screen.findByRole("heading",{name:"Clase, elevi și diriginți"})).toBeVisible(); });
