import type {
  ...
  PortfolioProcedure,
  PortfolioProcedureCreateInput,
  PortfolioProcedureUpdateInput,
...
export function createEducationApi(
  ...
  return {
    ...
    createPortfolioProcedure: (input: PortfolioProcedureCreateInput) => request<PortfolioProcedure>("/education/portfolios/procedures", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) }),
    updatePortfolioProcedure: (id, input: PortfolioProcedureUpdateInput) => request<PortfolioProcedure>(`/education/portfolios/procedures/${encodeURIComponent(id)}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) }),
