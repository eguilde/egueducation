...
export class EvaluationsPageComponent {
  ...
  protected readonly rowActions = computed<ServerTableRowAction<PersonnelEvaluation>[]>(() => [
    {
      key: 'open',
      icon: 'open_in_new',
  ...
  protected onActionClick(event: { action: string; row: PersonnelEvaluation }): void {
