...
const EVALUATION_SELF_REVIEWS_CHILD: EducationDetailChildResourceConfig = {
  ...
  createFields: [
    ...
    { field: 'assumed_score', label: 'Punctaj asumat', type: 'number', defaultValue: 0 },
...
const EVALUATION_CRITERIA_CHILD: EducationDetailChildResourceConfig = {
  ...
  createFields: [
    ...
    { field: 'self_score', label: 'Scor autoevaluare', type: 'number', defaultValue: 0 },
    { field: 'reviewer_score', label: 'Scor evaluator', type: 'number', defaultValue: 0 },
    { field: 'final_score', label: 'Scor final', type: 'number', defaultValue: 0 },
...
const EVALUATIONS_RESOURCE: EducationResourceConfig = {
  ...
  createFields: [
    ...
    { field: 'score', label: 'Punctaj', type: 'number', defaultValue: 0 },
